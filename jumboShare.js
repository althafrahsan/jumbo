(function($){
    $.fn.jumboShare = function( options ) {
        ...
        var settings = $.extend({
            ...
            text:"GHD Sports TV | Watch Live Cricket,Football or Any Sports On Your Android Mobile | Free  App Download |",
            twitterUsername:"",
            id: rand,
            total: 0,
        ...
        function init(){
         var code = "<div class='mct_jumboShare' id='jumboShare_"+settings.id+"'>"+
            "<div class='mct_jumboShare_container'>"+
             ...
             "<a target=_blank rel=nofollow href='https://www.facebook.com/sharer/sharer.php?u=http://ghdsports.com&t="+encodeURI(settings.text)+"?external' class='jumboShare_btn facebook'><sapn class='jumboShare_btn_text'>facebook</span></a>"+
               
                "<a target=_blank rel=nofollow href='whatsapp://send?text=GHD Sports TV | Watch Live Cricket,Football or Any Sports On Your Android Mobile | Free  App Download | Visit http://ghdsports.com | Dont Miss Copa America And Euro Cup Live Action' class='jumboShare_btn linkedin'><sapn class='jumboShare_btn_text'>WhatsApp</span></a>"+
                
                "<a target=_blank rel=nofollow href='https://twitter.com/intent/tweet?url=http://ghdsports.com&text="+encodeURI(settings.text)+"?external' class='jumboShare_btn twitter'><sapn class='jumboShare_btn_text'>Twitter</span></a>"+
                ...
                // "<a target=_blank rel=nofollow href='https://twitter.com/intent/tweet?via="+settings.twitterUsername+"&url="+encodeURIComponent(settings.url)+"&text="+encodeURI(settings.text)+"' class='jumboShare_btn twitter'><sapn class='jumboShare_btn_text'>Twitter</span></a>"+
                                 ...
                                 "<a target=_blank rel=nofollow href='https://plus.google.com/share?url="+encodeURIComponent(settings.url)+"%2F?external' class='jumboShare_btn google'><sapn class='jumboShare_btn_text'>Google+</span></a>"+
